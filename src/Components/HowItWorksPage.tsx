...
const HowItWorksPage = () => {
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-2 bg-white relative items-start lg:items-center px-4 sm:px-6 md:px-8 lg:px-0 max-w-[1480px] mx-auto">
      <img
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full pb-8 sm:pb-12 lg:pb-[100px] pt-6 sm:pt-8 justify-items-center sm:justify-items-start lg:justify-items-center">
